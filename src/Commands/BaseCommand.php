...
class BaseCommand extends Command
{
    ...
    private function saveSchemaFile()
    {
        ...
        $path = config('artisanapi.velocity.path.schema_files', resource_path('model_schemas/'));
    ...
    public function getOptions()
    {
        return [
            ...
            ['skip', null, InputOption::VALUE_REQUIRED, 'Skip Specific Items to Generate'],
